...
namespace BlogPessoalWeb.Controllers
{
    public class ArtigosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Titulo,Conteudo,DataPublicacao,CategoriaArtigoId,AutorId,Removido")] Artigo artigo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Titulo,Conteudo,DataPublicacao,CategoriaArtigoId,AutorId,Removido")] Artigo artigo)
        {
            if (ModelState.IsValid)
            {
